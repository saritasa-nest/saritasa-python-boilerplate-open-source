...
Report bugs at
<https://github.com/saritasa-nest/{{ package_name }}/issues>.
...
`{{ package_name }}` could always use more documentation,
whether as part of the official `{{ package_name }}` docs,
...
Ready to contribute? Here's how to set up `{{ package_name }}`
for local development.

Fork the [{{ package_name }}](https://github.com/saritasa-nest/{{ package_name }}) repo on GitHub.
